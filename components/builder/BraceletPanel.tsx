...
export function BraceletPanel({ isOpen, onClose }: BraceletPanelProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <Panel open={isOpen} onClose={onClose} title="Bracelet Information" direction="left">
        <div className="px-5 py-4">

        <div className="py-4 border-b border-neutral-100 flex gap-2 items-center">
          <input
              type="text"
              value={braceletName}
          ...
          {/* Usage bar */}
          <div className="py-4 border-b border-neutral-100 shrink-0">
